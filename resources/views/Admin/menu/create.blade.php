                    ...
                    <form action="{{ route('admin.menu.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                <input type="text" name="nama_menu" id="nama_menu" value="{{ old('nama_menu') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                <select name="tipe_harga" id="tipe_harga" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    <option value="satuan" {{ old('tipe_harga') == 'satuan' ? 'selected' : '' }}>Satuan</option>
                                    <option value="berat" {{ old('tipe_harga') == 'berat' ? 'selected' : '' }}>Berat</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="ikan_id" id="ikan_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    @foreach($ikans as $ikan)
                                        <option value="{{ $ikan->ikan_id }}" {{ old('ikan_id') == $ikan->ikan_id ? 'selected' : '' }}>{{ $ikan->nama_ikan }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div id="harga_satuan_div">
                                ...
                                <input type="number" name="harga" id="harga" value="{{ old('harga') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div id="harga_berat_div" style="display: none;">
                                ...
                                <input type="number" name="harga_per_100gr" id="harga_per_100gr" value="{{ old('harga_per_100gr') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="gambar_url" id="gambar_url" value="{{ old('gambar_url') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
