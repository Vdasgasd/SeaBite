                    ...
                    <form action="{{ route('admin.meja.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="nomor_meja" id="nomor_meja" value="{{ old('nomor_meja') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                @error('nomor_meja')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                            </div>
                            <div class="mb-4">
                                <label for="kapasitas" class="block text-sm font-medium text-gray-700">Kapasitas</label>
                                <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                ...
                                <option value="direservasi" {{ old('status') == 'direservasi' ? 'selected' : '' }}>Direservasi</option>
                            </select>
