        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.metode-masak.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="nama_metode" class="block text-sm font-medium text-gray-700">Nama Metode</label>
                            <input type="text" name="nama_metode" id="nama_metode" value="{{ old('nama_metode') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="biaya_tambahan" id="biaya_tambahan" value="{{ old('biaya_tambahan', 0) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
